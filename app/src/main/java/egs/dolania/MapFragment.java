...
public class MapFragment extends SupportMapFragment implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static double jsonlng=50.006663;
    public static double jsonlat=36.2804074;
    ...
    private void initCamera( Location location ) {
        ...
        getMap().addMarker(new MarkerOptions().position(new LatLng(jsonlat, jsonlng)).title("هتل"));
    ...
    public void onConnected(Bundle bundle) {
        ...
        mCurrentLocation.setLatitude( jsonlat );
        mCurrentLocation.setLongitude( jsonlng );
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        options.icon( BitmapDescriptorFactory.fromBitmap(
                BitmapFactory.decodeResource(getResources(), R.drawable.pin_drop ) ) );
